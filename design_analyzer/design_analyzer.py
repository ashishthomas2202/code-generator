...
def analyze(project):
    ...
    output must be in python dictionary format like {output_format} and it must be very detailed. output must not have any descriptive text before the dictionary.
"""
...
def createResponse(prompt):
    ...
    response = openai.Completion.create(
        ...
        max_tokens=2000,    # Adjust max_tokens based on desired response length
        top_p=1.0,
